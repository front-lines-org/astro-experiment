...
infoboxes:
  - conflict:
    ...
    territory:
      text: Independence of the Armenian-majority Republic of Artsakh, subsequent
    ...
    combatant1:
      text: " Artsakh (Nagorno-Karabakh) 🇦🇲 Armenia Foreign fighters Arms suppliers
        Diplomatic support"
      links:
        - text: Artsakh
          type: internal
    ...
    casualties3:
      text: 28,000–38,000 killed (1988–1994) 3,000 killed (May 1994 – August 2009)
...
Azerbaijan has received diplomatic support, namely for its territorial integrity, from three post-Soviet states that have territorial disputes: Ukraine,
